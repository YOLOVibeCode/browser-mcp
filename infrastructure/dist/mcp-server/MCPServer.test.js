...
describe('MCPServer', () => {
    ...
    describe('Resource Management', () => {
        ...
        it('should throw error for non-existent resource', async () => {
            await expect(server.getResourceContent('browser://non-existent/')).rejects.toThrow('Resource not found');
        });
    ...
    describe('Tool Management', () => {
        ...
        it('should throw error for non-existent tool', async () => {
            await expect(server.executeTool('nonExistent', {})).rejects.toThrow('Tool not found');
        });
