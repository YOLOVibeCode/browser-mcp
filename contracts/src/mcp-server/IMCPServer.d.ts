import type { MCPResource, MCPToolResult, MCPPrompt } from '../types/MCPTypes';
/**
...
export interface MCPPromptProvider {
    ...
    generate: (args: Record<string, string>) => Promise<MCPPrompt>;
}
/**
...
export interface IMCPServer {
     ...
     */
    getPrompt(name: string, args: Record<string, string>): Promise<MCPPrompt>;
    /**
     * Shutdown the server.
     */
