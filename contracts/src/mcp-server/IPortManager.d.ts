 ...
 */
export declare class NoAvailablePortError extends Error {
    constructor(message?: string);
}
export declare class PortAlreadyReservedError extends Error {
    constructor(port: number);
}
//# sourceMappingURL=IPortManager.d.ts.map