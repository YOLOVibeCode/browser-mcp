 ...
 */
export type EventSchema = TabActivatedEvent | TabDeactivatedEvent | FrameworkDetectedEvent | DOMUpdatedEvent | ResourceRequestedEvent | PortAllocatedEvent | SourceMapLoadedEvent | ConsoleMessageEvent;
