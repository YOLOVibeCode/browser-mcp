...
function generateUnixScript(osType) {
    ...
    return `#!/bin/bash
# Browser MCP v${version} - Auto-Setup Script
# Generated by Browser MCP Extension
# OS: ${osType}

set -e

echo "🚀 Browser MCP v${version} Setup"
echo "============================"
echo ""
...
async function main() {
    // Send ready signal
    sendMessage({ type: 'ready', version: getVersion() });
...
echo ""
echo "Browser MCP v${version} is now configured!"
echo ""
echo "Next steps:"
...
function generateWindowsScript() {
    const version = getVersion();
    return `@echo off
REM Browser MCP v${version} - Auto-Setup Script
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const version = getVersion();
    document.getElementById('extensionTitle').textContent = `Browser MCP v${version}`;
