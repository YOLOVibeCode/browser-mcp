...
function generateUnixScript(osType) {
    ...
    return `#!/bin/bash
# Browser MCP v4.0.1 - Auto-Setup Script
# Generated by Browser MCP Extension
# OS: ${osType}

set -e

echo "🚀 Browser MCP v4.0.1 Setup"
echo "============================"
echo ""
...
async function main() {
    // Send ready signal
    sendMessage({ type: 'ready', version: '4.0.1' });
...
echo ""
echo "Browser MCP v4.0.1 is now configured!"
echo ""
echo "Next steps:"
...
function generateWindowsScript() {
    return `@echo off
REM Browser MCP v4.0.1 - Auto-Setup Script
